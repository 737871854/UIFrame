...
public class ZipHelper
{
    ...
    public static bool UnZip(string zipedFile, string strDirectory = "", string password = "", bool overWrite = true)
    {
        bool result = false;
        try
        {
            ...
            while ((theEntry = s.GetNextEntry()) != null)
            {
                ...
                {
					FileStream streamWriter = File.Create(strDirectory + entryName);
					int size = 2048;
